...
export default function ByteForgeSolutions() {
  return (
        ...
        <div className="flex flex-col md:flex-row gap-8 lg:gap-12 max-w-6xl mx-auto">
          ...
          <div className="flex-1 space-y-6 text-lg md:text-xl text-gray-300 relative">
            ...
            <p className="[text-wrap:balance] text-justify">
              At ByteForge Solutions, we believe in building more than just software — we build digital foundations for your success. 
              As a passionate and forward-thinking IT company, we specialize in crafting customized web-based software, 
              scalable e-commerce solutions, mobile applications, and result-driven digital marketing strategies.
             
            </p>
            <p className="[text-wrap:balance] text-justify">
               With a customer-first mindset, we combine creativity, technical excellence, 
              and deep industry insight to help businesses evolve in the digital age. 
              Whether you're a startup, SME, or enterprise, we provide tailored digital 
